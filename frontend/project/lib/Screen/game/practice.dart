          ...
          child: FutureBuilder<List<BallRoute>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                // print(balls[0].routeFile.positions.white);
                return Row(
                  children: [
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          DrawingTool(
                            ...
                            boardX: widget.boardX * 0.91,
                            billiardInfo: balls[currentIndex].routeFile.billiardInfo,
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            // });
                            SetDeviceRoute(balls[currentIndex].routeSeq.toString());
                          },
                          style: gameButton,
                          child: Text(
                            '경로표시',
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            //   Navigator.pop(context);
                            // });
                            SetDeviceLocation(balls[currentIndex].locaSeq.toString());
                          },
                          style: gameButton,
                          child: Text(
                            '다시놓기',
...
class _TimeFormat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      '${creAt.year}.$createdMonth.$createdDay $createdHour:$createdMinute 생성됨',
